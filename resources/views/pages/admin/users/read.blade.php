            ...
            <div class="flex-shrink-0">
                <div class="flex gap-2">
                    ...
                    <div class="flex-1 font-semibold">
                        ...
                        <p>{{$student->user->created_at->format('d-m-Y H:i')}}</p>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="text-left *:py-2">
                                ...
                                <td>
                                    <div class="flex flex-col">
                                        ...
                                        <p class="text-gray-600">{{ $classroom->academicYear->name }}</p>
                                    </div>
                                </td>
                                <td>
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="/admin/students/{{$classroom->id}}" class="btn btn-primary">Lihat</a>
