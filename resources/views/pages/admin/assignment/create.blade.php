...
<div class="flex flex-col bg-white w-full rounded-md overflow-hidden shadow-md p-4">
    <form action="/admin/assignments" method="post" class="form-group">
        @csrf
        <div class="form-control">
            <label for="subject">Mata pelajaran</label>
            <input type="text" name="subject" value="{{$subject->name}}" disabled>
        ...
        <div class="flex flex-col items-center justify-between md:flex-row gap-3">
            <div class="flex-1 form-control">
                ...
                <input type="number" name="size" id="size" min="1" placeholder="contoh: 10" value="{{old('size')}}">
            </div>
        </div>
        <div class="flex flex-col items-center justify-between md:flex-row gap-3">
            <div class="flex-1 form-control">
