...
<div class="flex flex-col gap-6">
    ...
    <div class="flex-1">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            @foreach ( $assignment['answer_assignments'] as $item )
                ...
                <div class="flex flex-col gap-2 justify-between bg-white rounded-md shadow-md">
                    ...
                    <div class="flex-1 px-4 py-2">
                        <div class="flex flex-col gap-3">
                            <div class="flex-shrink-0">
                                <h4 class="truncate text-lg font-semibold text-blue-500">{{$item['student_classroom']['student']['user']['name']}}</h4>
                            </div>
                    ...
                    <div class="flex-shrink-0">
                        <div class="flex items-center gap-2 p-3">
                            <div class="flex-shrink-0">
                                <a href="/admin/scores/{{$item['score']['id']}}/edit?type=assignment" class="btn {{$item['score']['published'] ? 'btn-success' : 'btn-danger'}}">Publikasi</a>
                            </div>
                            <div class="flex-shrink-0">
                                <form action="/admin/scores/{{$item['id']}}" method="POST" delete-attribute="true" title-attribute="Hapus jawaban {{$item['student_classroom']['student']['user']['name']}}?" text-attribute="Nilai juga akan dihapus!">
                                    @csrf
                                    @method('DELETE')
